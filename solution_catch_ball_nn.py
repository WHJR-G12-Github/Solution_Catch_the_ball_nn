...
def eval_genomes(genomes, config): #######
    ...
    for gid,genome in genomes: #####
        ...
        # Creating a 'FeedForwardNetwork' using 'create()' function
        # Passing 'genome' and 'config' as parameters to 'create()'
        ...
        while True:
            ...
            # Calculating the ouput using 'activate()' function
            # Passing x-coordinates of ball and player as arguments to 'activate()'
            output = net.activate((ball.x, player.x))   
            if output[0] > 0.5:
               # Assigning the value of 'speed' variable as 5
               speed=5
